...
我们为你准备好了基础工程，以此为基础开发，可以为你省去大量配置和调试环境的时间。可前往 [examples](https://github.com/Authing/Guard/tree/v5/examples) 获取对应的代码。
...
```json
// angular.json
// 代码示例：https://github.com/Authing/Guard/tree/v5/examples/guard-angular/normal/angular.json
{
  "projects": {
    "architect": {
      "build": {
