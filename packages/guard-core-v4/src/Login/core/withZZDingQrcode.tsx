...
export const LoginWithZZDingQrcode = (props: any) => {
  ...
  return (
    <div className="wecom_container">
      ...
      >
        <iframe
          src={`https://login-pro.ding.zj.gov.cn/oauth2/auth.htm?response_type=code&client_id=${'authing_edu_1_dingoa'}&redirect_uri=${'https://core.id.zjedu.gov.cn/connection/social/zhezhengdingding/660a640009af1d947b17a66e/callback'}&scope=get_user_info&authType=QRCODE&embedMode=true`}
          width="100%"
          height="388"
          frameBorder="0"
          scrolling="no"
