...
import { EyVerifyCodeInput } from '../../MFA/VerifyCodeInput/ey'
...
export const EyGuardCheckCaptchaView = () => {
  ...
  const onFinishHandle = async (formValues: any) => {
    ...
    if (statusCode === 200) {
      ...
      if (enabledRegisterFillInfo && metaData.length > 0) {
        changeModule?.(GuardModuleType.EY_INVITE_COMPLETE, {
          ...initData,
          ...data,
          verifyAccount,
          metaData: metaData,
  ...
  return (
    <div className="g2-view-container ey-check-captcha">
      <div className="g2-view-content">
        <div className="header-content">
          <div className="caption">{t('common.ey.inputCaptcha')}</div>
          <div className="desc">
            {t('common.ey.verifyAccount', [
              verifyAccount &&
          ...
          <div className="hint">
            {t('common.ey.captchaMaxErrorCount', [
              initData.verifyCodeMaxErrCount
            ])}
          </div>
        </div>
        <Form
